...
public class OrganizationRequest implements Serializable {
  ...
  private List<Map<String, Object>> contactDetais;
  ...
  public List<Map<String, Object>> getContactDetais() {
    return this.contactDetais;
  }

  public void setContactDetais(List<Map<String, Object>> contactDetais) {
    this.contactDetais = contactDetais;
  }
